        ...
        Route::middleware(['admincountryblock', 'throttle:refresh', 'ipblockunblock', 'apichecking'])->group(function () {
            Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
                ...
                Route::middleware('auth', 'admin.auth')->group(function () {
                    ...
                    Route::get('/lineups', 'AdminMachineController@lineupindex');
                    Route::get('/lineups/create', 'AdminMachineController@lineupcreate');
                    Route::post('/lineups/create', 'AdminMachineController@lineupstore');
                    Route::get('/lineups/{id}', 'AdminMachineController@lineupshow');
                    Route::post('/lineups/{id}', 'AdminMachineController@lineupupdate');
                    Route::get('/lineups/delete/{id}', 'AdminMachineController@lineupdelete');

                    Route::get('/machines', 'AdminMachineController@machineindex');
                    Route::get('/machines/create', 'AdminMachineController@machinecreate');
                    Route::post('/machines/create', 'AdminMachineController@machinestore');
                    Route::get('/machines/{id}', 'AdminMachineController@machineshow');
                    Route::post('/machines/{id}', 'AdminMachineController@machineupdate');
                    Route::get('/machines/delete/{id}', 'AdminMachineController@machinedelete');

                    Route::get('/spare-parts', 'AdminMachineController@sparepartindex');
                    Route::get('/spare-parts/create', 'AdminMachineController@sparepartcreate');
                    Route::post('/spare-parts/create', 'AdminMachineController@sparepartstore');
                    Route::get('/spare-parts/{id}', 'AdminMachineController@sparepartshow');
                    Route::post('/spare-parts/{id}', 'AdminMachineController@sparepartupdate');
                    Route::get('/spare-parts/delete/{id}', 'AdminMachineController@sparepartdelete');

                    Route::get('/spare-part-requests', 'AdminMachineController@sparepartrequestindex')->name('sparepartrequestindex');
                    Route::get('/spare-part-requests/{id}', 'AdminMachineController@sparepartrequestshow')->name('sparepartrequestshow');
                    Route::post('/spare-part-requests/{id}', 'AdminMachineController@sparepartrequestupdate')->name('sparepartrequestupdate');

                    Route::get('/machine-documents', 'AdminMachineController@machinedocumentindex');
                    Route::get('/machine-documents/create', 'AdminMachineController@machinedocumentcreate');
                    Route::post('/machine-documents/create', 'AdminMachineController@machinedocumentstore');
                    Route::get('/machine-documents/{id}', 'AdminMachineController@machinedocumentshow');
                    Route::post('/machine-documents/{id}', 'AdminMachineController@machinedocumentupdate');
                    Route::get('/machine-documents/delete/{id}', 'AdminMachineController@machinedocumentdelete');

                    Route::get('/lineup-documents', 'AdminMachineController@lineupdocumentindex');
                    Route::get('/lineup-documents/create', 'AdminMachineController@lineupdocumentcreate');
                    Route::post('/lineup-documents/create', 'AdminMachineController@lineupdocumentstore');
                    Route::get('/lineup-documents/{id}', 'AdminMachineController@lineupdocumentshow');
                    Route::post('/lineup-documents/{id}', 'AdminMachineController@lineupdocumentupdate');
                    Route::get('/lineup-documents/delete/{id}', 'AdminMachineController@lineupdocumentdelete');
            ...
            Route::group(['namespace' => 'User', 'prefix' => 'customer'], function () {
                Route::group(['namespace' => 'Auth'], function () {
                    ...
                    Route::post('/register', 'RegisterController@register')
                        ->name('register')
                        ->middleware('guest:customer');
                    Route::post('/register1', 'RegisterController@registers')
                        ->name('register1')
                        ->middleware('guest:customer');
                    ...
                    Route::post('/forgotpasswordajax', 'Passwords\ForgotpasswordController@Emailajax')
                        ->name('ajax.forgot')
                        ->middleware('guest:customer');
                    Route::post('/change-password', 'ChangepasswordController@changepassword')->name('change.password');
                    Route::get('/{token}/reset-password', 'Passwords\ResetpasswordController@resetpassword')
                        ->middleware('guest:customer')
                        ->name('reset.password');
                ...
                Route::middleware('auth:customer', 'customer.auth')->group(function () {
                    ...
                    Route::get('/spare-part-request', 'SparePartController@index')->name('spare-part-request');
                    Route::post('/spare-part-request', 'SparePartController@store')->name('spare-part-request-store');
                    Route::get('/spare-part-request/new', 'SparePartController@new')->name('spare-part-request-new');
                    Route::get('/spare-part-request/{id}', 'SparePartController@show')->name('spare-part-request-show');
                    Route::post('/spare-part-request/{id}', 'SparePartController@update')->name('spare-part-request-update');

                    Route::get('/machines', 'DashboardController@machines')->name('machines');
                    Route::get('/machine/{id}', 'DashboardController@singlemachine')->name('machine');
                    Route::get('/lineup/{id}', 'DashboardController@singlelineup')->name('lineup');
                    ...
                    Route::get('/rating/{ticket_id}', 'Ticket\TicketController@rating')
                        ->name('rating')
