...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        (function($) {
            ...
            // Datatable
            $('#support-lineupdocumentlist').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ url('/admin/lineup-documents') }}"
                },
                columns: [{
                        data: 'id',
                        name: 'id',
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                type: "get",
                                url: SITEURL + "/admin/lineup-documents/delete/" + _id,
                                success: function(data) {
                                    toastr.error(data.error);
                                    var oTable = $('#support-lineupdocumentlist').dataTable();
                                    oTable.fnDraw(false);
                                },
                                error: function(data) {
