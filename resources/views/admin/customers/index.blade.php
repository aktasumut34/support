    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title"><span
                    class="font-weight-normal text-muted ms-2">{{ trans('langconvert.adminmenu.customers') }}</span></h4>
        </div>
    </div>
    <!--End Page header-->
            ...
            <div class="card-header d-sm-max-flex border-0">
                ...
                <div class="card-options mt-sm-max-2">
                    @can('Customers Create')
                        <a href="{{ url('admin/customer/create') }}" class="btn btn-success me-3"><i
                                class="feather feather-user-plus"></i> {{ trans('langconvert.admindashboard.addcustomer') }}</a>
                    @endcan
            ...
            <div class="card-body">
                <div class="table-responsive spruko-delete">
                    @can('Customers Delete')
                        <button id="massdelete" class="btn btn-outline-light btn-sm data-table-btn mb-4"><i
