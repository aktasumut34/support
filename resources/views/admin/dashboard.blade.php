...
<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" style="margin-bottom: 30px">
    <div style="display: flex; gap:6px;">
        <h4 class="page-title" style="display: inline;">Notifications</h4>
        <a href="{{route('admin.markAllNotification')}}" class="btn btn-danger btn-sm" style="margin-left: auto;">Mark All Read</a>
        <a href="{{route('notificationpage')}}" class="btn btn-primary btn-sm">View All</a>
    </div>
    @foreach( auth()->user()->unreadNotifications()->paginate(2) as $notification)
        @if($notification->data['status'] == 'New')
        <a class="mark-as-read" href="{{$notification->data['link']}}" data-id="{{ $notification->id }}" style="margin-bottom: .5em;">
                    ...
                    <div class="d-flex">
                        <div class="ps-3">
                            ...
                            <p class="fs-13 mb-1 text-wrap">
                                ...
                                @else
                                {{trans('langconvert.adminmenu.newticket')}} {{ $notification->data['ticket_id'] }}
                                @endif
                            </p>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        <div class="ps-3">
                            ...
                            <div class="small" style="text-white">
                                {{ $notification->created_at->diffForHumans() }}
                            </div>
                        </div>
                    </div>
        ...
        <a class="mark-as-read" href="#" data-id="{{ $notification->id }}" style="margin-bottom: .5em;">
            <div class="alert alert-info" role="alert">
                <div class="d-flex ">
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-start"> <span class="fs-14 font-weight-semibold">{{trans('langconvert.adminmenu.activetickets')}}</span>
                                    <h3 class="mb-0 mt-1  mb-2">{{$active->count()}}</h3>
                                </div>
                            </div>
                            <div class="col-4">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-start"> <span class="fs-14 font-weight-semibold">{{trans('langconvert.adminmenu.onholdtickets')}}</span>
                                    <h3 class="mb-0 mt-1  mb-2">{{$onhold->count()}}</h3>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="icon1 bg-primary brround my-auto  float-end"> <i class="las la-ticket-alt"></i> </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-start"> <span class="fs-14 font-weight-semibold">{{trans('langconvert.adminmenu.assigntickets')}}</span>
                                    <h3 class="mb-0 mt-1  mb-2">{{$assigned->count()}}</h3>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="icon1 bg-primary brround my-auto  float-end"> <i class="las la-ticket-alt"></i> </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="mt-0 text-start"> <span class="fs-14 font-weight-semibold">{{trans('langconvert.adminmenu.overduetickets')}}</span>
                                    <h3 class="mb-0 mt-1  mb-2">{{$overdue->count()}}</h3>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="icon1 bg-primary brround my-auto  float-end"> <i class="las la-ticket-alt"></i> </div>
    ...
    (function($) {
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, conf) {
                        ...
                        if (id.length > 0) {
                            ...
                            toastr.error('{{trans('
                                langconvert.functions.checkboxselect ')}}');
                        }
        ...
        $('body').on('click', '#assigned', function() {
            ...
            $.get('admin/assigned/' + assigned_id, function(data) {
                ...
                $(".modal-title").text('{{trans('
                    langconvert.admindashboard.assigntoagent ')}}');
