                                        ...
                                        <form action="{{route('mail.customersend')}}" method="post">
                                            ...
                                            <div class="card-body">
                                                <div class="row form-group">
                                                    <label for="channels" class="form-label col-sm-2">Channels</label>
                                                    <div class="row col-sm-10">
                                                        <div class="col-sm-6 col-lg-4 col-xl-3 @error('channels') is-invalid @enderror"
                                                            style="display: flex; flex-direction: column;">
                                                            <div class="switch_section" style="margin: unset;">
                                                                <div class="switch-toggle d-flex">
                                                                    <a class="onoffswitch2">
                                                                        <input type="checkbox" id="onoffswitchNotification"
                                                                            value="database"
                                                                            class="toggle-class onoffswitch2-checkbox"
                                                                            name="channels[]">

                                                                        <label for="onoffswitchNotification"
                                                        ...
                                                        <div class="col-sm-6 col-lg-4 col-xl-3 @error('channels') is-invalid @enderror"
                                                            ...
                                                            <div class="switch_section" style="margin: unset;">
                                                                <div class="switch-toggle d-flex">
                                                                    <a class="onoffswitch2">
                                                                        <input type="checkbox" id="onoffswitchEmail"
                                                                            value="mail"
                                                                            class="toggle-class onoffswitch2-checkbox"
                                                                            name="channels[]">

                                                                        <label for="onoffswitchEmail"
                                                                            class="toggle-class onoffswitch2-label"></label>
                                                                    </a>
                                                                    <div class="ps-3">
