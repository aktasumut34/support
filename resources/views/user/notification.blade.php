                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                ...
                                                <small>
                                                    ...
                                                    @else
                                                    {{trans('langconvert.usermenu.newticket')}} <strong> {{ $notification->data['ticket_id'] }} </strong>
                                                    @endif </small>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex end">
                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small> {{trans('langconvert.usermenu.closeticket')}} <strong> {{ $notification->data['ticket_id'] }}</strong> </small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex end">
                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small> {{trans('langconvert.usermenu.onholdticket')}} <strong> {{ $notification->data['ticket_id'] }}</strong> </small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex end">
                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small> {{trans('langconvert.usermenu.overdueticket')}} <strong> {{ $notification->data['ticket_id'] }}</strong> </small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex end">
                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small> {{trans('langconvert.usermenu.reopenticket')}} <strong> {{ $notification->data['ticket_id'] }} </strong> </small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex end">
                                        ...
                                        <div class="me-3  mt-1 d-block">
                                            <a href="{{$notification->data['clink']}}" data-id="{{ $notification->id }}">
                                                <p class="mb-0 fs-13  mark-as-read"><span class="font-weight-semibold"> {{$notification->data['title'] }} </span> <span class="text-muted"> ({{ $notification->created_at->diffForHumans() }})</span></p>
                                                <small> {{trans('langconvert.usermenu.repliedticket')}} <strong> {{ $notification->data['ticket_id'] }}</strong> </small>
                                            </a>
                                        </div>
                                    </div>
                                </div>
